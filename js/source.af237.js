...
/******/ 	__webpack_require__.p = "/react-todo/";
/******/
/******/
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(1),m=__webpack_require__(140),p=__webpack_require__(4),v=__webpack_require__(7),da=__webpack_require__(141),ea=__webpack_require__(142),fa=__webpack_require__(143),ha=__webpack_require__(6);
...
var _reactHotLoader = __webpack_require__(149);

var _Scheduler = _interopRequireDefault(__webpack_require__(151));
...
var _stylesM = _interopRequireDefault(__webpack_require__(152));
...
var _reactFlipMove = _interopRequireDefault(__webpack_require__(164));

var _Task = _interopRequireDefault(__webpack_require__(165));

var _Spinner = _interopRequireDefault(__webpack_require__(172));
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_createTaskAsync", async e => {
      ...
      const newTask = await _REST.api.createTask(newTaskMessage.trim());
      this.setState(prevState => ({
        tasks: (0, _instruments.sortTasksByGroup)([newTask, ...prevState.tasks]),
        newTaskMessage: ''
      }));
    ...
    _defineProperty(this, "_updateTaskAsync", async updatingTask => {
      const {
        tasks
      } = this.state;
      ...
      const updatedTask = await _REST.api.updateTask(updatingTask);
      const updatedTasks = tasks.map(task => {
        return task.id === updatedTask.id ? updatedTask : task;
      });
      this.setState({
        tasks: (0, _instruments.sortTasksByGroup)(updatedTasks)
      });
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      ...
      const incompletedTasksToCompleted = tasks.filter(task => !task.completed).map(task => {
        task.completed = true;
        return task;
      });
      ...
      await _REST.api.completeAllTasks(incompletedTasksToCompleted);
      this.setState(({
        tasks
      }) => {
        tasks.map(task => {
    ...
    _defineProperty(this, "_filterTasks", () => {
      const {
        tasks,
        tasksFilter
      } = this.state;
...
const api = {
  async fetchTasks() {
    const response = await fetch(_.MAIN_URL, {
      headers: {
  ...
  async completeAllTasks(taskArray) {
    const requests = taskArray.map(task => fetch(_.MAIN_URL, {
      method: 'PUT',
      headers: {
        Authorization: _.TOKEN,
        'Content-Type': 'application/json'
...
var _stylesM = _interopRequireDefault(__webpack_require__(167));

var _Checkbox = _interopRequireDefault(__webpack_require__(10));

var _Star = _interopRequireDefault(__webpack_require__(169));

var _Edit = _interopRequireDefault(__webpack_require__(170));

var _Remove = _interopRequireDefault(__webpack_require__(171));
...
class Task extends _react.PureComponent {
  ...
  render() {
    ...
    const taskStyle = (0, _classnames.default)(_stylesM.default.task, {
...
class Spinner extends _react.Component {
  render() {
    return this.props.isSpinning ? _react.default.createElement("div", {
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.af237.js.map